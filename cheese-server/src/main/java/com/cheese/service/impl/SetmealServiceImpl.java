...
public class SetmealServiceImpl extends ServiceImpl<SetmealMapper, Setmeal> implements SetmealService {
    ...
    public IPage<SetmealVO> getPageWithCategory(SetmealPageQueryDTO setmealPageQueryDTO) {
        return setmealMapper.selectPageVO(
                ...
                new QueryWrapper<SetmealVO>()
                        ...
                        .eq((Long)BaseContext.getCurrentId() != null, "s.merchant_id", (Long)BaseContext.getCurrentId())
    ...
    public void saveSetmeal(SetmealDTO setmealDTO) {
        ...
        setmeal.setMerchantId((Long)BaseContext.getCurrentId());
        ...
        if (setmealDishes != null && setmealDishes.size() > 0) {
            ...
            setmealDishes.forEach(setmealDish -> setmealDish.setMerchantId((Long)BaseContext.getCurrentId()));
        }
    ...
    public void changeStatus(Integer status, Long id) {
        ...
        if (status == StatusConstant.ENABLE) {
            List<SetmealDish> setmealDishesWithDishId = setmealDishMapper.selectList(new LambdaQueryWrapper<SetmealDish>()
                    ...
                    .eq((Long)BaseContext.getCurrentId() != null, SetmealDish::getMerchantId, (Long)BaseContext.getCurrentId())
